...
inline constexpr const char* PDO_LOG_CSV_HEADER =
    ...
    "main_tx_idc_actual,main_tx_iq_command,main_tx_id_command,main_tx_motor_temp_2,main_tx_power_stage_temp_1,"
    // main rx
    ...
    "dut_tx_idc_actual,dut_tx_iq_command,dut_tx_id_command,dut_tx_motor_temp_2,dut_tx_power_stage_temp_1,"
    // dut rx
