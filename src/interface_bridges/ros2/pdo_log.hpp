...
struct PdoLogRecord {
    ...
    float    dut_tx_power_stage_temp_3   = 0.f;
...
inline constexpr const char* PDO_LOG_CSV_HEADER =
    ...
    "main_tx_power_stage_temp_3,main_tx_power_stage_temp_2,main_tx_motor_temp,main_tx_error_code,"
    ...
    "dut_tx_power_stage_temp_3,dut_tx_power_stage_temp_2,dut_tx_motor_temp,dut_tx_error_code,"
