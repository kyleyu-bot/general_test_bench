...
struct PdoLogRecord {
    ...
    float    main_tx_power_stage_temp_3  = 0.f;  ///< 0x205D
    ...
    float    main_tx_power_stage_temp_1  = 0.f;  ///< 0x2061  (°C)
    float    main_tx_power_stage_temp_2  = 0.f;  ///< 0x2064  (°C)
    ...
    float    dut_tx_power_stage_temp_3   = 0.f;  ///< 0x205D
    ...
    float    dut_tx_power_stage_temp_1   = 0.f;  ///< 0x2061  (°C)
    float    dut_tx_power_stage_temp_2   = 0.f;  ///< 0x2064  (°C)
...
inline constexpr const char* PDO_LOG_CSV_HEADER =
    ...
    "main_tx_idc_actual,main_tx_imu_accel_x,main_tx_iq_command,main_tx_id_command,main_tx_motor_temp_2,main_tx_power_stage_temp_1,main_tx_power_stage_temp_2,"
    // main rx
    ...
    "dut_tx_idc_actual,dut_tx_imu_accel_x,dut_tx_iq_command,dut_tx_id_command,dut_tx_motor_temp_2,dut_tx_power_stage_temp_1,dut_tx_power_stage_temp_2,"
    // dut rx
